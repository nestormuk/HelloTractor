              ...
              <div class="car-details col-12 col-sm-4">
                ...
                <div class="car-button-actions">
                  <a class="text-decoration-none" href="<%= request.getContextPath() %>/car-bid?id=${car.idCar}">
                    <button class="btn btn-primary" style="background-color: #FF461E">Place Bid</button>
                  </a>
                  <a class="text-decoration-none" href="<%= request.getContextPath() %>/send-inquiry/${car.idCar}">
                    <button class="btn btn-warning">Send Inquiry</button>
                  </a>
