...
public class UserCarServiceImpl implements UserCarService {
  ...
  @Autowired
  private SendInquiriesRepository testDriveRepo;
  ...
  @Override
  public List<SendInquiries> listSendInquiries() {
    return sendInquiriesRepository.findAll();
  }

  @Override
  public void saveInquiry(String date, UserAccount user, Car car, String message) {
