<nav class="navbar navbar-expand-lg sticky-top p-0">
  <div class="container">
    <a class="navbar-brand fw-bold fs-5" href="<%= request.getContextPath() %>/">Hello Tractor</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto me-0 me-lg-auto fw-semibold">
        ...
        <li class="nav-item me-0 me-lg-3">
          <a class="nav-link" href="<%= request.getContextPath() %>/cars">Tractors</a>
        </li>
        <li class="nav-item me-0 me-lg-3">
          <a class="nav-link" href="<%= request.getContextPath() %>/user/post-car">Sell a Tractor</a>
        </li>
      </ul>
      ...
      <security:authorize access="!isAuthenticated()">
        <div class="nav-button d-flex flex-column flex-lg-row">
          ...
          <a href="<%= request.getContextPath() %>/register" class="btn btn-primary mb-3 mb-lg-0" style="background-color: #FF461E">Register</a>
        </div>
      </security:authorize>
        ...
        <ul class="navbar-nav fw-semibold">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="<%= request.getContextPath() %>/user/my-posted-car"><i class="fa-solid fa-car"></i> My Posted Tracto</a>
              </li>
              <li>
                <a class="dropdown-item" href="<%= request.getContextPath() %>/user/inquiries"><i class="fa-regular fa-envelope"></i> Inquiries</a>
              </li>
              <!-- Admin Dashboard -->
