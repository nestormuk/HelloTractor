        ...
        <div class="d-flex">
          ...
          <aside class="sidebar-user pe-md-3">
            <ul>
              ...
              <li>
                <a href="<%= request.getContextPath() %>/user/my-posted-car"><i class="fa-solid fa-car"></i> My Posted Tractors</a>
              </li>
              <li>
                <a href="<%= request.getContextPath() %>/user/inquiries"><i class="fa-regular fa-calendar-check"></i> Inquiries</a>
              </li>
            </ul>
          </aside>
