      ...
      <div class="container pt-5">
        <div class="d-flex">
          ...
          <aside class="sidebar-user pe-md-3">
            <ul>
              ...
              <li class="active-page">
                <a href="<%= request.getContextPath() %>/user/my-posted-car"><i class="fa-solid fa-car"></i> My Posted Tractor</a>
              </li>
              <li>
                <a href="<%= request.getContextPath() %>/user/inquiries"><i class="fa-regular fa-envelope"></i> My Inquiries</a>
              </li>
          ...
          <div class="content-wrapper">
            <h2 class="fw-bold mb-3">Posted Tractors</h2>
            <!-- Table -->
